...
summary: "Part 1 of a muli-part series on Mobile Ad-hoc Networks, Mesh Networks and Self-Routing Network Capsules as I explore them for disaster communication"
description: ""
draft: false
toc: false
autonumber: false
...
[^1]: The internet is a collection of Autonomous Systems (AS) not ISPs. An autonomous system can be something like a university, a lab, an ISP, government, etc. Really, any large enough network (or [small one](https://en.wikipedia.org/wiki/RIPE_NCC)) can be an AS. All you need is a subnet of public IP (a bunch of IP addresses that are yours) and an ASN (Autonomous System Number). These are assigned by the Internet Assigned Numbers Authority (IANA)
